...
if($_POST["type"] == "search"){
    $listepharmacie = $pharmacieC->affichermedRecherche($_POST["search"]);
  }
  else if($_POST["type"] == "tri"){
    $listepharmacie = $pharmacieC->afficherMedtri();
  }
}
  else
  $listepharmacie = $pharmacieC->afficherpharmacie();
if (
    ...
    isset($_POST["image"])
        ...
        $pharmacieC->Ajoutermed($pharmacie);
  ...
  <?php
    ...
    <li>
        ...
        <div class="article-info">
            ...
            <div class="actions">
            <a href="supprimer.php?num=<?php echo $Pharmacie['numero']; ?>" >  <i class="fas fa-trash ">    </i>
            </a>
            <a href="modifpage.php?num=<?php echo $Pharmacie['numero']; ?>" >  <i class="fas fa-edit ">    </i> 
            </a>
  </div>

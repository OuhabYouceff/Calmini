...
=======
                        <a class="text-decoration-none text-body pe-3" href=""><i class="bi bi-telephone me-2"></i>+216 52 940 699</a>
                        <span class="text-body">|</span>
                        <a class="text-decoration-none text-body px-3" href=""><i class="bi bi-envelope me-2"></i>calmini-tn@gmail.com</a>
>>>>>>> origin/abdelmonam
                    </div>
                </div>
...
=======
                        <a class="text-body px-2" href="https://facebook.com/jarray222/">
>>>>>>> origin/abdelmonam
...
=======
                        <a class="text-body px-2" href="https://instagram.com/abdo_n3/">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a class="text-body ps-2" href="https://youtube.com/nf/">
>>>>>>> origin/abdelmonam
...
=======
          <img src="../img/profile-1.jpg" alt="profile photo" class="rounded-circle" style="width: 35px;">
        </div>
        <div class="info d-flex flex-column text-start">
          <p class="mb-0">Bonjour, <b>Ahmed</b></p>
          <small class="text-muted">Admin</small>
        </div>
      </div>
    </a>
    <ul class="dropdown-menu dropdown-menu-end border-0" aria-labelledby="profileDropdown">
      <li><a href="#" class="dropdown-item">Mon profil</a></li>

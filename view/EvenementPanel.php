  ...
  <?php
    ...
    <li>
        ...
        <div class="article-info">
            ...
            <div class="actions">
            <a href="deletepage.php?num=<?php echo $Evenement['Id_event']; ?>" >  <i class="fas fa-trash ">    </i>
            </a>
            <a href="updatepage.php?num=<?php echo $Evenement['Id_event']; ?>" >  <i class="fas fa-edit ">    </i> 
            </a>
  </div>
